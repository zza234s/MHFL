...
result_floder=model_heterogeneity/result/new_0719

# Method setup
method=Local
script_floder="model_heterogeneity/methods/"${method}
main_cfg=${script_floder}"/${method}""_on_"${dataset}".yaml"
exp_name="HPO_"$method"_on_"$dataset"_CV_high_model_heterogeneity"
...
wandb_name_project="HPO_"$method"_on_"$dataset"_CV_high_model_heterogeneity"
