...
#
#
# # def get_prive_dataset(args) -> FederatedDataset:
# #     #assert args.dataset in Priv_NAMES.keys()
# #     return Priv_NAMES[args.data.type](args)
# #
# # def get_public_dataset(args) -> PublicDataset:
# #     #assert args.public_dataset in Pub_NAMES.keys()
# #     return Pub_NAMES[args.MHFL.public_dataset](args)