...
#     if 'resnet18_proto_official' in model_config.type:
#         resnet = resnet18(model_config, pretrained=False, num_classes=model_config.num_classes)
#         if model_config.pretrain_resnet:
#             initial_weight = model_zoo.load_url(model_urls['resnet18'])
#             initial_weight_1 = resnet.state_dict()
#             for key in initial_weight.keys():
#                 if key[0:3] == 'fc.' or key[0:5]=='conv1' or key[0:3]=='bn1':
#                     initial_weight[key] = initial_weight_1[key]
#             resnet.load_state_dict(initial_weight)
#         return resnet
#
