...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropout_rate=0.0, input_channels=3, return_features=False):
...
def wrn_16_1(num_classes, input_channels, return_features, dropout_rate=0):
...
def wrn_16_2(num_classes, input_channels, return_features, dropout_rate=0):
...
def wrn_40_2(num_classes, input_channels, return_features, dropout_rate=0):
    return WideResNet(depth=40, num_classes=num_classes, widen_factor=2, dropout_rate=dropout_rate,
                      input_channels=input_channels, return_features=return_features)


def call_wrn(model_config, input_shape):
    if 'wrn_16_1' in model_config.type:
