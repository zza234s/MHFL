...
def cct_6(*args, **kwargs):
    return _cct(num_layers=6, num_heads=4, mlp_ratio=2, embedding_dim=512,
                *args, **kwargs)
...
def call_cct_proto(model_config, local_data):
    if 'cct_proto' in model_config.type:
...
register_model('call_cct_proto', call_cct_proto)
